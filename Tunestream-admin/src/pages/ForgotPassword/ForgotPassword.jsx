        ...
        >
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-extrabold text-[var(--text-primary)] tracking-tight">
              Forgot <span className="logo-text">Password</span>
            </h1>
            <p className="text-[var(--text-secondary)] mt-2 font-medium opacity-60">
              Enter your admin email to reset
            </p>
          </div>

          {message && <div className="text-emerald-400 mb-6 text-center text-sm font-semibold">{message}</div>}
